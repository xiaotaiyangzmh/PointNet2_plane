...
from datasets import SyntheticCombinedData
...
def parse_args():
    ...
    parser.add_argument('--train_path', type=str, default=None, help='Rootpath of tarin set, "./data_synthetic/pcd_combined_train" [default: None]')
    parser.add_argument('--test_path', type=str, default=None, help='Rootpath of test set "./data_synthetic/pcd_combined_test" [default: None]')
...
def main(args):
    ...
    train_set = SyntheticCombinedData(args.train_path, num_classes, num_points)
    ...
    test_set = SyntheticCombinedData(args.test_path, num_classes, num_points)
