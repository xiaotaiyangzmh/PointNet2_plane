...
def main(args):
    ...
    test_scene_set = SceneData(rootpath, num_classes, num_points, train_ratio)
    ...
    with torch.no_grad():
        ...
        for batch_idx in range(num_batches):
            ...
            if args.visual:
                fout = open(os.path.join(visual_dir, str(scene_id[batch_idx]) + '_pred.obj'), 'w')
                fout_gt = open(os.path.join(visual_dir, str(scene_id[batch_idx]) + '_gt.obj'), 'w')
            ...
            # whole_scene_data: The whole point cloud XYZRGB
            # whole_scene_label: The whole label at each point idx
            # vote_label_pool: The predicted class at each point idx
            ...
            filename = os.path.join(visual_dir, str(scene_id[batch_idx]) + '.txt')
