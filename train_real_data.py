...
def main(args):
    ...
    if args.plot == True:
        ...
        plt.title('Mean Loss during Training and Testing with both Planes and Non-planes')
        plt.xlabel('Epoch')
        plt.ylabel('Loss')
        plt.legend()
        ...
        plt.title('Accuracy during Training and Testing with both Planes and Non-planes')
        plt.xlabel('Epoch')
        plt.ylabel('Accuracy (%)')
        plt.legend()
