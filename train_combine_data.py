...
def parse_args():
    ...
    parser.add_argument('--datapath1', type=str, default=None, help='Rootpath of dataset 1, "./data_plane/pointcloud" [default: ]')
    parser.add_argument('--datapath2', type=str, default=None, help='Rootpath of dataset 2, "./data_scene" [default: None]')
    parser.add_argument('--batch_size', type=int, default=16, help='Batch Size during training [default: 16]')
    parser.add_argument('--train_ratio1', default=0.9, type=float, help='Ratio of train set [default: 0.9]')
    parser.add_argument('--train_ratio2', default=0.7, type=float, help='Ratio of train set [default: 0.7]')
...
def main(args):
    ...
    train_set = MixedData(rootpath1, rootpath2, num_classes, num_points, args.train_ratio1, args.train_ratio2, "train")
    ...
    test_set = MixedData(rootpath1, rootpath2, num_classes, num_points, args.train_ratio1, args.train_ratio2, "test")
